    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a href="{{ url('admin/dokumens/edit', $d->id) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-edit"></i>
                        </a>
                        <a href="{{ url('admin/dokumens/destroy', $d->id) }}" onclick="return ConfirmDelete();" class="btn btn-danger btn-sm">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ url('admin/dokumens/download', $d->id) }}" class="btn btn-primary btn-sm">
