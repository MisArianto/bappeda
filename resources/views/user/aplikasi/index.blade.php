                        ...
                        output += `
                            ...
                            <td>
                              <div class='btn-group'>
                                ...
                                <button class="btn btn-danger btn-sm" data-id="${item.id}" id="handleDelete" url="{{ url('user/aplikasi/destroy') }}">
                                  <i class="fa fa-trash"></i>
                                </button>
                              </div>
                            </td>
