                                      ...
                                      <div class="col-md-1">
                                        <div class="card-body">
                                         <a href="#" id="handleEdit" data-id="${item.id}" data-name="${item.name}" data-image="${item.image}" class="text-info">
                                          ...
                                          <a href="#" id="handleDelete" data-id="${item.id}" url="{{ url('user/fotos/destroy') }}" class="text-danger">
