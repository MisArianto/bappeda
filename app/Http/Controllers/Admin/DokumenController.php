...
class DokumenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dokumen.index', compact('dokumens'))->with('no', 1);
    }
    ...
    public function create()
    {
        ...
        $pics = PIC::latest()->get();
        return view('admin.dokumen.add', compact('tahuns', 'sumbers', 'versis', 'kategoris', 'pics', 'keterangans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('admin/dokumens')->with('success', 'Tambah Data berhasil');
    ...
    public function edit($id)
    {
        ...
        $kategoris = Kategori::latest()->get();
        $pics = PIC::latest()->get();
        return view('admin.dokumen.edit', compact('model', 'tahuns', 'sumbers', 'versis', 'kategoris', 'pics', 'keterangans'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('admin/dokumens')->with('success', 'Update Data berhasil');
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/dokumens')->with('success', 'Delete Data berhasil');
    }
