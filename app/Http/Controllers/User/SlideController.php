...
class SlideController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.slide.index', compact('slides'))->with('no', 1);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
           ...
           if($request->has('slide'))
            ...
            return redirect('user/slides')->with('success', 'Tambah Data berhasil');
    ...
    public function edit($id)
    {
        ...
        return view('user.slide.edit', compact('model'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('user/slides')->with('success', 'Update Data berhasil');
    ...
    public function indexing($id)
    {
        ...
        return redirect('user/slides')->with('success', 'Indexing Data berhasil');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('user/slides')->with('success', 'Delete Data berhasil');
    }
}
